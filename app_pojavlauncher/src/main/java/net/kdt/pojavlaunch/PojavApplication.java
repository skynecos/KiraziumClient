...
public class PojavApplication extends Application {
    ...
    public static final ExecutorService sExecutorService = new ThreadPoolExecutor(4, 4, 500,
    ...
    private void installFatalErrorHandler() {
        Thread.setDefaultUncaughtExceptionHandler((thread, th) -> {
            boolean storagePermAllowed = (Build.VERSION.SDK_INT < 23 ||
                    ...
                    PojavApplication.this, android.Manifest.permission.WRITE_EXTERNAL_STORAGE) ==
                    PackageManager.PERMISSION_GRANTED) && Tools.checkStorageRoot(PojavApplication.this);
            File crashFile = new File(storagePermAllowed ? Tools.DIR_GAME_HOME : Tools.DIR_DATA,
                    "latestcrash.txt");
            try {
            ...
            FatalErrorActivity.showError(PojavApplication.this, crashFile.getAbsolutePath(),
                    storagePermAllowed, th);
            Tools.fullyExit();
        });
    }
    ...
    public void onCreate() {
        ...
        // Disable fatal errors on gplay so Google can collect the crash report data.
        ...
        try {
            ...
            if (Architecture.isx86Device() && Architecture.is32BitsDevice()) {
                ...
                getApplicationInfo().nativeLibraryDir = originalJNIDirectory.substring(0,
                        originalJNIDirectory.lastIndexOf("/")).concat("/x86");
            }
